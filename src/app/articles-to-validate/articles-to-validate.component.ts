...
export class ArticlesToValidateComponent {
  ...
  SelectedRows(element:PeriodicElement){
    this.priorityId = element.position
    this.dialog.open(ProfilDescriptionComponent, { data: "toys.gif",width: '120%',
    height: '90%' });
    
  }
  OtherProfil(element:PeriodicElement){
